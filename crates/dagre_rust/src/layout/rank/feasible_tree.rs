...
pub fn feasible_tree(g: &mut Graph<GraphConfig, GraphNode, GraphEdge>) -> Graph<GraphConfig, GraphNode, GraphEdge> {
 ...
 * tree.
 */
fn tight_tree(t: &mut Graph<GraphConfig, GraphNode, GraphEdge>, g: &Graph<GraphConfig, GraphNode, GraphEdge>) -> usize {
  fn dfs(v: &String, t: &mut Graph<GraphConfig, GraphNode, GraphEdge>, g: &Graph<GraphConfig, GraphNode, GraphEdge>) {
 ...
 * it.
 */
fn find_min_stack_edge(t: &Graph<GraphConfig, GraphNode, GraphEdge>, g: &Graph<GraphConfig, GraphNode, GraphEdge>) -> Option<Edge> {
  let edges = g.edges();
  let result = edges.iter().map(|e| {
...
fn shift_ranks(t: &Graph<GraphConfig, GraphNode, GraphEdge>, g: &mut Graph<GraphConfig, GraphNode, GraphEdge>, delta: i32) {
  let nodes = t.nodes();
  for node_id in nodes.into_iter() {
